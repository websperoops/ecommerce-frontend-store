...
const Checkout = () => {
  ...
  const selectAddress = (addressValue) => {
    ...
    if (findAddress.length > 0) {
      setValue("address", findAddress[0].address ? findAddress[0].address : "");
      setValue("city", findAddress[0].city ? findAddress[0].city : "");
      setValue("zipCode", findAddress[0].zip ? findAddress[0].zip : "");
      setValue("province", findAddress[0].province ? findAddress[0].province : "");
      const user = JSON.parse(Cookies.get("userInfo"));
      let result = { ...user, address: findAddress[0].address ? findAddress[0].address : "", city: findAddress[0].city ? findAddress[0].city : "", zipCode: findAddress[0].zip ? findAddress[0].zip : "", province: findAddress[0].province ? findAddress[0].province : "" }
      ...
      const user = JSON.parse(Cookies.get("userInfo"));
      let result = { ...user, address: "", city: "", zipCode: "", province: "Ontario" }
      Cookies.set("userInfo", JSON.stringify(result))
    }
  }
  return (
                  ...
                  <div className="grid grid-cols-6 gap-4 lg:gap-6 mt-10">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      <button
                        ...
                        disabled={!stripe || isCheckoutSubmit || Cookies.get("addToCartStatus") === "Yes"}
